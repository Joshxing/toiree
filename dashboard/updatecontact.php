              ...
              <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="firstnameInput" class="form-label">Map Location</label>
                                                        <input type="text" class="form-control" id="locationInput" name="location" value="<?php print 'https://www.google.com/maps?q=' . $latitude . ',' . $longitude ?>">
                                                    </div>
                                                </div>
